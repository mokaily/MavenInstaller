...
public class Constants {
    ...
    public static final String Error_Maven_Build = "❌ Error running Maven build!\n";
    public static final String Select_Install_Path = "⚠️ Please select a install path!\n";
    public static final String Invalid_Repository = "❌ Invalid repository URL!\n";
    public static final String Cloning_Repository = "⏳ Cloning repository...\n";
    public static final String Project_Exist = "⚠️ Project already exists. Deleting...";
    public static final String Project_Deleted = "✅🗑️ Project folder deleted successfully.";
    public static final String Project_Deleted_Failed = "❌🗑️ Deletion failed: ";
    public static final String Clone_Failed = "❌ Git clone failed with exit code: ";
    public static final String Clone_Error = "❌ Error cloning repository:\n";
    public static final String Build_Error = "❌ Error building repository:\n";
    public static final String Clone_Completed = "✅ Cloning completed!\n";
    public static final String Build_Completed = "✅ Building completed!\n";
    public static final String Maven_Detected = "✅ Maven project detected.";
    public static final String Maven_Not_Found = "⚠️ No Maven project found.";
    public static final String Custom_Maven_Empty = "❗ Custom Maven repository path is empty!\n";
    public static final String Custom_Maven_Invalid = "❗ Custom Maven repository path is invalid or not a directory!\n";
    public static final String Target_Folder_Found = "❌ target/ folder not found at: ";
    public static final String Jar_Not_Found = "⚠️ No .jar files found in target/";
    public static final String Pom_Error = "❌ Error reading pom.xml: ";
    public static final String Config_Imported = "✅ Config imported successfully from: ";
    public static final String Config_Not_Imported = "❌ Failed to import config: ";
    public static final String Clean_Completed = "✅ Cleaning completed.\n";
    public static final String Deleted = "🗑️ Deleted: ";
    public static final String Failed_To_Move = "⚠️ Failed to move: ";
    public static final String Moved = "✅📦 Moved: ";
    public static final String Skipped = "➡️ Skipped: ";
    public static final String Dir_Is_Empty = "⚠️ Directory is empty or inaccessible.";
    public static final String Clean_Start = "🧹 Cleaning project folder...\n";
    public static final String ReadMe_Read_Failed = "⚠️ Could not read README.md\n";
    public static final String ReadMe_Not_Found = "⚠️ README.md not found.\n";
    public static final String ReadMe = "README.md";
    public static final String Project_Info = "Project Information:\n";
    public static final String Invalid_URL = "⚠️ Invalid repository URL!\n";
    public static final String Fetch_Contact_Error = "❌ Error fetching owner's contact info.\n";
    public static final String Fetch_Contact_Failed = "❌ Failed to fetch owner's info.\n";
    public static final String Fetch_Contact_Start = "⏳ Fetching owner's contact info...\n";
    public static final String ProjectID_Fetch_Failed = "❌ Failed to fetch project ID.\n";
    public static final String ProjectID_Fetch_Done = "✅ Project ID: ";
    public static final String ProjectID_Fetch_Not_Found = "⚠️ Project ID is not found.\n";
    public static final String Branches_Fetch_Failed = "❌ Failed to fetch branches!\n";
}
